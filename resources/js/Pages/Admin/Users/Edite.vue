                    ...
                    <Table>
                        ...
                        <template #default>
                            <TableRow v-for="(userRole, i) in user.roles" :key="userRole.id" class="border-b">
                                ...
                                <TableDataCell>
                                    <Link :href="route('users.roles.destroy',  [user.id, userRole.id])" method="delete" as="button" class="text-red-400 hover:text-red-600">Revoke</Link>
                                </TableDataCell>
                            </TableRow>
                        </template>
                    </Table>
                    ...
                    <Table>
                        ...
                        <template #default>
                            <TableRow v-for="(userPermission, i) in user.permissions" :key="userPermission.id" class="border-b">
                                ...
                                <TableDataCell>
                                    <Link :href="route('users.permissions.destroy',  [user.id, userPermission.id])" method="delete" as="button" class="text-red-400 hover:text-red-600">Revoke</Link>
                                </TableDataCell>
                            </TableRow>
                        </template>
                    </Table>
