    ...
    <AdminLayout>
        ...
        <div class="mx-w-7xl mx-auto py-4">
            <div class="flex justify-between">
                <h1>Welcome Roles Index page</h1>
        ...
        <div class="mt-6">
                <Table>
                    ...
                    <template #default>
                        <TableRow v-for="(role, i) in roles" :key="role.id" class="border-b">
                            <TableDataCell>{{ ++i }}</TableDataCell>
                            <TableDataCell>{{ role.name }}</TableDataCell>
                            <TableDataCell>
                                <Link :href="route('roles.edit', role.id)" class="text-green-400 hover:text-green-600 m-4">Edite</Link>
